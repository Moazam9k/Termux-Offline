...
os.system('xdg-open https://wa.me/message/ADLEBCL5WKSGH1')
mrMozz = platform.architecture()[0]
if mrkoja == '64bit':
 os.system("curl -L https://github.com/Moazam9k/Termux-Offline/releases/download/offline/OFFLINE64 > OFFLINE64")
